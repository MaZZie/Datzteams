Datzteams.grid.Datzteams = function(config) {
    config = config || {};
    Ext.applyIf(config,{
        id: 'datzteams-grid-datzteams'
        ,url: Datzteams.config.connectorUrl
        ,baseParams: { action: 'mgr/datzteam/getList' }
        ,save_action: 'mgr/datzteam/updateFromGrid'
    ...
    Datzteams.grid.Datzteams.superclass.constructor.call(this,config)
};
Ext.extend(Datzteams.grid.Datzteams,MODx.grid.Grid,{
...
Ext.reg('datzteams-grid-datzteams',Datzteams.grid.Datzteams);
