...
class DatzteamsTeammanagerManagerController extends modExtraManagerController {
    ...
    public function loadCustomCssJs() {
        $this->addJavascript($this->datzteams->config['jsUrl'].'mgr/widgets/players.grid.js');
        $this->addJavascript($this->datzteams->config['jsUrl'].'mgr/widgets/teammanager.panel.js');
